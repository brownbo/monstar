import * as service from '../services/evalGifts'
...
export default modelExtend(pageModel, {
  ...
  effects: {
    * query ({payload = {}}, {call, put, select}) {
      ...
      const opts = {
        query: {
          ...
          limit: limit,
          count: 'true',
          include:'eval_customer,gift,reply_user',
          is_first_eval:'1',
          ...payload.query,
        }
      }
      ...
      if(payload.back)yield put(push('/giftsevaluate'));
    },
    ...
    * update ({payload}, {select, call, put}) {
      const id = yield select(({evalGifts})=>evalGifts.currentItem.id);
      const opts = {
        id,
        ...payload
      }
