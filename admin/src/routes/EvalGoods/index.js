...
class EvalGifts extends React.Component {
  ...
  render() {
    const searchProps = {
      ...
      getGoodsDefault_data: this.getGoodsDefault_data,
      getGoodsSearch_data: this.getGoodsSearch_data,
      search_data_goods: this.props.goods.search_data,
      default_data_goods: this.props.goods.default_data,
      //评价人
    ...
    const tableProps = {
      ...
      //新页面方法
      goDetail: (record)=> {
        this.props.dispatch(push(`/shopevaluate/${record.id}`))
      },
    };
...
export default connect(({evalGoods, goods, customer, app, loading})=>({
  currModel: evalGoods,
  goods,
  customer,
  app,
