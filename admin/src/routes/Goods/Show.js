...
class GoodsShow extends React.Component {
  ...
  constructor(props) {
    ...
    this.props.dispatch({type: `goods/getDetail`,payload: {...id}})
  }
  handlePreview = (url) => {
    this.setState({
      previewImage:url,
  ...
  handBack = () => {
    this.props.dispatch(push("/goods"));
  }
  render() {
    ...
    const imgs = currentItem.goods_detail+","+currentItem.previews;
    return (
      <div className={styles.show_content}>
        <div className="content_item">
          ...
          <div className="item_rt">
            ...
            <div className="item_li"><div className="li_name">预览图片:</div><div className="li_value">
            <div className="img_div">{
              currentItem.previews?currentItem.previews.split(',').map(img=>{
                return (<img key={img} onClick={e=>{this.handlePreview(img)}} src={img} className="show_img" alt=""/>)
              }):''}
              </div>
              </div></div>
            <div className="item_li"><div className="li_name">详情图片:</div><div className="li_value">
                <div className="img_div">{
                  currentItem.goods_detail?currentItem.goods_detail.split(',').map(img=>{
                    return (<img key={img} onClick={e=>{this.handlePreview(img)}} src={img} className="show_img" alt=""/>)
                  }):''}
                </div>
              </div></div>
            <div className="item_li"><div className="li_name">是否推荐:</div><div className="li_value">{currentItem.is_recommend?'是':'否'}</div></div>
        ...
        <div className="content_item">
          ...
          <div className="item_rt">
            <div className="item_li"><div className="li_name">活动支付方式:</div><div className="li_value">{payTypeText[activity.pay_type?activity.pay_type:0]}</div></div>
        ...
        <div className="content_item">
          ...
          <div className="item_rt">
            <div className="item_li"><div className="li_name">提交人电话:</div><div className="li_value">{currentItem.phone}</div></div>
...
export default connect(({goods})=>({goods}))(GoodsShow)
