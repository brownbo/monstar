...
class Shop_type extends React.Component {
  state = {
    query: {}, //搜索条件，翻页会默认取这里的值
  }
  constructor(props) {
    super(props);
    this.api_name = 'shop_type';
  }
  ...
  render() {
    ...
    const modalProps = {
      ...
      title: `${this.props.currModel.modalType === 'create' ? '新建商户分类' : '更新商户分类'}`,
...
export default connect(({ shop_type, app, loading }) => ({ currModel: shop_type, app, loading }))(Shop_type)