...
class ShopsettleTable extends React.Component {
  state = {
    query:{},//搜索条件，翻页会默认取这里的值
  }
  constructor(props) {
    super(props);
    this.api_name = 'shopsettleTable';
  }
  componentDidMount() {
...
export default connect(({shopsettleTable,shop,app, loading})=>({currModel: shopsettleTable,shop,app,loading}))(ShopsettleTable)
