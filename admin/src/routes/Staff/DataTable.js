...
import {Table, Spin, Modal,Button,Alert,Upload,Icon,message} from 'antd';
  ...
  render() {
    ...
    return (
      <Spin tip="加载中..." spinning={loading}>
        <div className="marginBt16px marginTop10">
          {<Button type='primary' className="marginRight10" icon="plus" onClick={this.props.addBtn}>新增</Button>}
          {this.state.showDelBtn?<Button type='danger'className="marginRight10" icon="delete" onClick={this.deleteSeletedRows}>删除</Button>:''}
          {/* <Upload action="/admin/api/upload"  
