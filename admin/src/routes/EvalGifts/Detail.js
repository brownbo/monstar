...
class EvalGiftDetail extends React.Component {
  state = {
    btnType: false,
    reply_content: '',
  }
  ...
  handClick = () => {
    this.props.form.validateFields((errors) => {
      ...
      let data = {
        ...
        gift_id: this.props.evalGifts.currentItem.gift_id,
        reply_time: new Date(),
  ...
  render() {
    const {currentItem, childEvalList} = this.props.evalGifts;
...
EvalGiftDetail.propTypes = {
  evalGifts: PropTypes.object,
  gift: PropTypes.object,
  customer: PropTypes.object,
  loading: PropTypes.object,
  dispatch: PropTypes.func,
}
export default connect(({evalGifts, gift, customer, loading,login})=>({
  evalGifts,
  gift,
  customer,
  loading,
  login
}))(Form.create()(EvalGiftDetail))
