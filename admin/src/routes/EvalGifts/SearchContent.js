...
class SearchContent extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.props.getGiftDefault_data();
  ...
  search_model_func_gift = (value) => {
    ...
    this.props.getGiftSearch_data(value);
  }
  ...
  render() {
    ...
    //根据礼品名称
    const {default_data_gift, search_data_gift, default_data_customer, search_data_customer} = this.props;
    const gift_option = Func.getSelectOptions(search_data_gift, default_data_gift, this.isSearchNull);
